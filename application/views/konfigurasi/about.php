...
echo validation_errors('<div class="alert alert-warning">','</div>');
		...
		echo form_open_multipart(base_url('konfigurasi/about'),' class="form-horizontal"');
		?>
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<input type="file" name="about" class="form-control" placeholder="Upload banner Beranda 1 Baru"
							value="<?php echo $konfigurasi->about ?>">
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<br> <img src="<?php echo base_url('assets/banner/'.$konfigurasi->about) ?>"
