...
echo validation_errors('<div class="alert alert-warning">','</div>');
		...
		echo form_open_multipart(base_url('konfigurasi/slider_1'),' class="form-horizontal"');
		?>
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<input type="file" name="slider_1" class="form-control"
							placeholder="Upload Slider Beranda 1 Baru" value="<?php echo $konfigurasi->slider_1 ?>">
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<br> <img src="<?php echo base_url('assets/slider/'.$konfigurasi->slider_1) ?>"
