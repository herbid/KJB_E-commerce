	...
	<div class="card card-primary">
		...
		<div class="card-body">
			...
			<?php 
				...
				echo form_open_multipart(base_url('konfigurasi/slider_3'),' class="form-horizontal"');
				?>
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						<label>Upload Slider Beranda 1 Baru</label>
						<input type="file" name="slider_3" class="form-control"
							placeholder="Upload Slider Beranda 1 Baru" value="<?php echo $konfigurasi->slider_3 ?>">
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<br> <img src="<?php echo base_url('assets/slider/'.$konfigurasi->slider_3) ?>"
