		...
		<div class="card-body">
            ...
            foreach ($kategori as $key => $value) { ?>
					...
					<tr class="text-center">
						...
						<td><button type="button" class="btn  btn-sm btn-outline-warning" data-toggle="modal"
								data-target="#edit<?= $value->id_kategori ?>"><i class="fa fa-edit"></i>Edit</button>
...
<div class="modal fade" id="delete<?= $value->id_kategori ?>">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<h5>Anda Yakin Untuk Menghapus Kategori <?= $value->nama_kategori ?> !!! </h5>	
