		...
		<div class="row ">
				...
				<div class="m-l-25 m-r--38 m-lr-0-xl">
					<div class="wrap-table-shopping-cart">
						<table class="table-shopping-cart center">
							...
							<?php 
							 $i = 1;
							 $kopet = $this->m_home->get_cart();
							 $sub_ttl=null;
							 $all_ttl=null;
							 $berat=null;
							 foreach ($kopet as $key => $value) {
							...
							<tr class="table_row ">
								<td class="column-1">
									<div class="how-itemcart1">
										<img src="<?php echo base_url('assets/gambar/' . $value->gambar) ?>" alt="IMG">
									</div>
								</td>
								<td class="column-2"><?php echo $value->nama_barang; ?></td>
								<td class="column-3 "> <?=rupiah($value->harga); $sub_ttl= $sub_ttl+($value->jumlah*$value->harga); ?></td>
								<td class="column-2 ">
									<div class="wrap-num-product flex-w m-l-auto m-r-0">
										<button class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m" id="plush"
											data-id_keranjang="<?= $value->id_keranjang?>">
											<i class="fs-16 zmdi zmdi-minus"></i>
										</button>

										<input class="mtext-104 cl3 txt-center num-product" type="number" name="qty"
										 value="<?=$value->jumlah; $berat=$berat+($value->jumlah*$value->berat) ?>" min="0">
								...
								<td class="column-5 ">
									<a href="<?php echo base_url('keranjangbelanja/del/'.$value->id_keranjang) ?>"onclick="return confirm('yakin Ingin Menghapus Data ?')"
					...
					<div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
						...
						<!-- Button trigger modal -->
							...
							<a href="<?php echo base_url('keranjangbelanja/delete') ?>" 	
								class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10 btn-lg pull-right" onclick="return confirm('yakin Ingin Menghapus Semua Data 	?')">
			...
			<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
				<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
					...
					<a href="<?=base_url('keranjangbelanja/checkout')?>" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
						Proceed to Checkout
					</a>
				</div>
			</div>
...
<!-- Modal -->
<div class="modal fade" id="edit_jumlah" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	  ...
	  <div class="row">
                            <div class="col-lg-6 col-md-12">
								...
								<!-- <div class="success__img-wrap">
									...
									<img class="u-img-fluid" src="gambar"id="gambar" alt=""></div> -->
                                    <div class="success__info-wrap">
									<span class="success__price">Nama Produk</span>
									<input id="id_keranjang"   class="s-option__link input-text--primary-style">
									<input id="nama_barang"  class="s-option__link input-text--primary-style" readonly>
									
									<span  class="success__price">Harga Produk</span>
