...
<header class="header-v4">
		...
		<div class="top-bar">
			<div class="content-topbar flex-sb-m h-full container">
				<div class="left-top-bar">
					<marquee behavior="scroll" direction="left"><?php echo $site->alamat ?></marquee>
				</div>
		...
		<div class="wrap-menu-desktop">
			<nav class="limiter-menu-desktop p-l-45">
				...
				<a href="<?=base_url()?>" class="logo">
					<img src="<?=base_url('assets/gambar/'.$site->icon)?>" alt="IMG-LOGO">
				</a>
	...
	<div class="menu-mobile">
		<ul class="topbar-mobile">
			<li>
				<div class="left-top-bar">
				<marquee><?php echo $site->alamat ?></marquee>
				</div>
			</li>
	...
	<div class="wrap-header-cart js-panel-cart">
		...
		<div class="header-cart flex-col-l p-l-65 p-r-25">
			...
			<div class="header-cart-content flex-w js-pscroll">
				...
				else if($this->session->userdata('id_pelanggan')!=null	){   ?>
