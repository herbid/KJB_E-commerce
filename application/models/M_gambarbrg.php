...
class M_gambarbrg extends CI_Model {

  public function get_all_data(){
      
     $this->db->select('barang.*,count(gambar.id_barang) as jmlh_gmbr ');
     $this->db->from('barang');
   ...
   public function get_data($id_gambar){
    ...
    public function delete($data){
      ...
      // $hasil = $this->db->query("DELETE FROM gambar WHERE id_gambar='$data[id_gambar]'");
      // return $hasil;
